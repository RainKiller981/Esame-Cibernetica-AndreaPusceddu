...
# Let's inspect GeometryNodeInstanceOnPoints inputs
node_tree = bpy.data.node_groups.new(name="Debug_Tree", type='GeometryNodeTree')
nodes = node_tree.nodes
node_inst = nodes.new('GeometryNodeInstanceOnPoints')
print("InstanceOnPoints inputs:")
for idx, inp in enumerate(node_inst.inputs):
    print(f"Input {idx}: name='{inp.name}', identifier='{inp.identifier}'")
"""
