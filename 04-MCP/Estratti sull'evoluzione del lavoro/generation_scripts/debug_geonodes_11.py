...
node_tree = bpy.data.node_groups.new(name="Debug_Tree_11", type='GeometryNodeTree')
modifier = bpy.context.active_object.modifiers.new(name="Test", type='NODES') if bpy.context.active_object else None
