...
node_tree = bpy.data.node_groups.new(name="Debug_Tree_8", type='GeometryNodeTree')
...
print("InstanceOnPoints inputs key test:")
for k in node_inst.inputs.keys():
    print(k)

try:
    print("Connecting Points:")
    print(node_inst.inputs['Points'])
except Exception as e:
    print("inst.inputs['Points'] failed:", e)

try:
    print("Connecting Instance:")
    print(node_inst.inputs['Instance'])
except Exception as e:
    print("inst.inputs['Instance'] failed:", e)
"""
