...
def main():
    ...
    try:
        print("PolyHaven Status:")
        print(send_command(sock, "get_polyhaven_status"))
        
        print("\nSketchfab Status:")
        print(send_command(sock, "get_sketchfab_status"))
        
        print("\nHunyuan3D Status:")
        print(send_command(sock, "get_hunyuan3d_status"))
        
        print("\nHyper3D Status:")
        print(send_command(sock, "get_hyper3d_status"))
    except Exception as e:
        print(f"Error: {e}")
    finally:
        sock.close()
