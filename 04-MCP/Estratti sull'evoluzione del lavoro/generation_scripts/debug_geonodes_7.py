...
node_tree = bpy.data.node_groups.new(name="Debug_Tree_7", type='GeometryNodeTree')
...
try:
    print(node_in.outputs["Geometry"])
except Exception as e:
    print("outputs['Geometry'] failed:", e)

try:
    print(node_in.outputs[sock_in.identifier])
except Exception as e:
    print("outputs[sock_in.identifier] failed:", e)

try:
    print(node_in.outputs[0])
except Exception as e:
    print("outputs[0] failed:", e)
"""
